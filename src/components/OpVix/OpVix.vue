<template>
    ...
    <div>
        <div id="OpVix" ref="OpVix" style="width:90%; height:700% ;float:left"></div>
    </div>
</template>
    ...
    methods: {
        ...
        */
        draw(data) {
            ...
            this.chartLeft = echarts.init(this.$refs.OpVix);
        ...
        */
        fresh(data) {
            //console.log({ "time": [data[0], data[1]], "name": "opvix", "targetcode": this.$store.state.QuoteType, "opcode": "", "front": "1" })
            get_data({ "time": [data[0], data[1]], "name": "opvix", "targetcode": this.$store.state.QuoteType, "opcode": "", "front": "1" })
                .then(response => {
        ...
        */
        InitialDataGraph(startTime, stopTime) {
            ...
            console.log({ "time": [start, stop], "name": "opvix", "targetcode": "510050.XSHG", "opcode": "", "front": "1" })
            get_data({ "time": [start, stop], "name": "opvix", "targetcode": this.$store.state.QuoteType, "opcode": "", "front": "1" })
                .then(response => {
                    this.data = response.data.map(this.process)
