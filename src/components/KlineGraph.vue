<template>
    ...
    <div>
        <h1>名义本金</h1>
        <div id="KlineGraph1" ref="KlineGraph1" style="width:50%; height:500px;float:left"></div>
        <div id="KlineGraph2" ref="KlineGraph2" style="width:50%; height:500px;float:right"></div>
    </div>
...
import { test } from '@/request/index.js'
...
export default {
    ...
    methods: {
        ...
        drawLine(data) {
            ...
            //console.log(data)
            var data0 = this.process_data2(data)//this.splitData(data);
            //console.log(data0)
            // k线配置项
            ...
            this.charts = echarts.init(this.$refs.KlineGraph1);
            this.charts.setOption(option);

            this.charts2 = echarts.init(this.$refs.KlineGraph2);
        ...
        fresh() {
            ...
            console.log(this.data[this.data.length-1],d)

            this.data.push(d)
            var data0 = this.process_data2(this.data)
            //console.log(data0.values2.length)
        ...
        getData() {
            test({
                ...
                .then(response => {
                    ...
                    this.charts.on('updateAxisPointer',
                        this.debounce((event) => {
                            var xAxisInfo = event.axesInfo[0];
                            if (xAxisInfo) {

                                var data0 = this.right(this.data);
                                //console.log(data0)
